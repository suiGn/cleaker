  ...
  try {
    ...
    socket.on("chat message", function (msg) {
      ...
      orgboatDB.query(`insert into messages(chat_uid, u_id, message,time,delete_message,
        ...
        ,response_type,response_file,ogTitle, ogDescription, ogImage, isExitGroup, width, height) 
    ...
    socket.on("get messages", function (msg) {
      ...
      messages.ogDescription,  messages.ogImage, messages.isExitGroup, messages.width, messages.height
      ...
      orgboatDB.query(
        ...
        function (err, rows) {
          ...
          orgboatDB.query(
            ...
            messages.ogDescription, messages.ogImage, usrs.pphoto
            FROM messages
            inner join usrs on messages.u_id = usrs.u_id
            inner join chats_users on messages.u_id = chats_users.u_id
